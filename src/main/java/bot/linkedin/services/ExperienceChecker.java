...
public class ExperienceChecker {
    ...
    public static final Logger log = LoggerFactory.getLogger(ExperienceChecker.class);
    ...
    public ExperienceChecker(JobApplyConfig applyConfig, QuestionAnswerService qaService) {
