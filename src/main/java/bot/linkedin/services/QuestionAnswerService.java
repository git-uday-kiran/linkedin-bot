...
public class QuestionAnswerService {
    ...
    private static final Logger log = org.apache.logging.log4j.LogManager.getLogger(QuestionAnswerService.class);
    ...
    private static Consumer<Throwable> handleNumberFormatException() {
        return e -> System.out.println("Enter number format input.");
    }
