...
public class Tasks extends BasePage {
    ...
    private static final Logger log = org.apache.logging.log4j.LogManager.getLogger(Tasks.class);
    ...
    public void performSearchQuery(String searchQuery) {
        ...
        By searchLocator = By.xpath("//header/div/div/div/div[2]/div/div/div/div/div/div/div/input[1]");
